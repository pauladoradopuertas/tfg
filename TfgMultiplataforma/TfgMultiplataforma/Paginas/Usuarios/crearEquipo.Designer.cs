namespace TfgMultiplataforma.Paginas.Usuarios
{
    partial class crearEquipo
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            button_cancelar_crear.Font = new Font("Segoe UI", 12F);
            button_cancelar_crear.Location = new Point(198, 522);
            button_cancelar_crear.Name = "button_cancelar_crear";
            button_cancelar_crear.Size = new Size(151, 50);
            button_cancelar_crear.TabIndex = 41;
            button_cancelar_crear.Text = "Cancelar";
            button_cancelar_crear.UseVisualStyleBackColor = true;
            button_cancelar_crear.Click += button_cancelar_crear_Click;
            // 
            // button_editar_crear
            // 
            button_editar_crear.Font = new Font("Segoe UI", 12F);
            button_editar_crear.Location = new Point(657, 522);
            button_editar_crear.Name = "button_editar_crear";
            button_editar_crear.Size = new Size(151, 50);
            button_editar_crear.TabIndex = 40;
            button_editar_crear.Text = "Editar equipo";
            button_editar_crear.UseVisualStyleBackColor = true;
            ...
            // button_anadir_crear
            // 
            button_anadir_crear.Location = new Point(464, 315);
            button_anadir_crear.Name = "button_anadir_crear";
            button_anadir_crear.Size = new Size(140, 33);
            button_anadir_crear.TabIndex = 37;
            button_anadir_crear.Text = "Añadir miembro";
            button_anadir_crear.UseVisualStyleBackColor = true;
            ...
            listBox_miembros_crear.Size = new Size(716, 144);
            ...
            label_titulo_crear.Font = new Font("Segoe UI", 15F, FontStyle.Bold);
            label_titulo_crear.Location = new Point(398, 9);
            label_titulo_crear.Name = "label_titulo_crear";
            label_titulo_crear.Size = new Size(166, 35);
